...
//==============================================================================
    ...
    public function getAuthor() : array
    {
        return[
                'id' => 0,
                'name' => 'mfJordi',
                'description'=> 'Hier komt een korte (of lange) omschrijving over deze auteur',
            ];
    } 
...
//==============================================================================
    ...
    public function getArticlesByAuthorId() : array
    // NOTE: function does not actually need the id
    {
        return[
                'Article1' => [
                        'id' => 0,
                        'title' => 'A beginners guide to programming',
                ],
                'Article2' => [
                        'id' => 1,
                        'title' => 'An intermediate guide to programming',
                ],
                'Article3' => [
                    'id' => 2,
                    'title' => 'An expert guide to dealing with programming PTSD',
                ],
            ];
